...
public class Ejercicio11 {
    ...
    public static void main(String[] args) {
        ...
        int[] array3 = arrayDeDuplicados(array1, array2);
    ...
    public static int[] arrayDeDuplicados(int[]a, int[]b) {
        int[] ar = new int[b.length];
        int elementosAñadidos = 0;
        for (int i = 0; i < b.length; i++) {
            if (indexOf(a, i) != -1) {
...
//Este método devuelve -1 si no hay valores duplicados en un array, o la posición del valor duplicado si lo hay.
