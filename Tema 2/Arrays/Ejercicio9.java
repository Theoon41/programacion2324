...
public class Ejercicio9 {
    ...
    public static void main(String[] args) {
        ...
        int reverse = MiEntradaSalida.leerEnteroPositivo("Si quieres el orden al reves introduce 1 si no 0");
        ...
        int[] array2 = burbuja(array1, inversor);

        System.out.println(Arrays.toString(array2));

    }

    public static int [] burbuja(int []a, boolean b){
        int aux;
